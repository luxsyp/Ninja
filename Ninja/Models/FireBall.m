...
- (id) init
{
    if (self = [super init])
    {
        [self setSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"fireball_0001.png"]];
...
- (void) createAnimation
{
    ...
    for (int i = 1 ; i <= 6; i++)
    {
        [walkAnimFrames addObject:
         [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
          [NSString stringWithFormat:@"fireball_00%.2d.png",i]]];
    }
    CCAnimation *animationWalk = [CCAnimation animationWithSpriteFrames: walkAnimFrames delay:0.025f];
    ...
    for (int i = 1 ; i <= 9; i++)
    {
        [dieAnimFrames addObject:
         [[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:
          [NSString stringWithFormat:@"fireball_hit_00%.2d.png",i]]];
    }
